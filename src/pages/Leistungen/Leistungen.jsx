            ...
            <section className="service-section-container">
                ...
                <div className="part1">
                    ...
                    <ul className="service-section-list-container">
                        ...
                        <li className="service-section-listitem">EKG</li>
                        <li className="service-section-listitem">
                    ...
                    <ul className="service-section-list-container">
                        <li className="service-section-listitem">
                            nach orthopädischen Operationen (z.B. zur
                            Schmerztherapie)
                        </li>
                        <li className="service-section-listitem">
                        ...
                        <li className="service-section-listitem">
                            zur Motivation der Bewegung bei älteren Tieren oder
                ...
                <div className="part2">
                    ...
                    <ul className="service-section-list-container">
                        ...
                        <li className="service-section-listitem">
                            Behandlung von Reptilien und anderen Terrarientieren
                        </li>
                        <li className="service-section-listitem">
                            Parasitenprophylaxe und -therapie
                        </li>
                        <li className="service-section-listitem">
                            Naturheilkunde, Homöopathie und Bachblüten
                        </li>
                    </ul>
                    <h2 className="service-section-sub-head sub-head">
                        Zahnheilkunde
                    ...
                    <p className="service-section-paragraph paragraph">
                        In Notfällen,bei Bestandsbetreuungen oder Fällen einer
                        Transportunfähigkeit des Patienten halten wir auch
                        Hausbesuche ab. Eine weitergehende Untersuchung und
                        Behandlung des Patienten ist jedoch häufig nur in der
                        Praxis möglich.
                    </p>
                    <br />
                    <p className="service-section-paragraph paragraph">
                        Bitte haben Sie Verständnis, dass unser “normaler”
